...
const about_me = {
  ...
  image_alt:
    "This is an image of a young man with tan skin and dark brown curly hair. He is wearing large headphones and a black t-shirt, and is looking directly at the camera with a slight smile and a friendly expression. The background is indistinct, suggesting he is in an indoor environment.",
  paragraphs: [
    "Hello, welcome!",
    "I'm Gustavo Mello, also known as Mographllo, a graphic designer and software developer with extensive experience in both system development and audiovisual production.",
  ...
  return (
    <section className="flex flex-col gap-4">
      <div className="p-6 border border-[#00171F] dark:border-[#F4E285] rounded-3xl max-w-[550px]">
        <Image
          src={about_me.image_url}
          alt={about_me.image_alt}
          width={0}
          height={0}
          sizes="100vw"
          className="w-full h-auto border border-[#00171F] dark:border-[#F4E285] rounded-2xl"
        />
      </div>
