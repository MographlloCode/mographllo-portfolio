  ...
  return (
    <section id="resume" className="flex flex-col w-full gap-16">
      <main className="flex flex-col gap-16 overlay-x-hidden">
        <header>
          <h1 className="harmond-semibold text-5xl text-[#00171F] dark:text-[#F4E285]">
            Resume
          </h1>
        </header>
        <section className="flex flex-col gap-8">
          <h1 className="montserrat font-semibold text-xl text-[#00171F] dark:text-[#F8F7FF]">
            Work Experience
          </h1>
        ...
        <section className="flex flex-col gap-4 w-fit">
          ...
          <div className="flex gap-8 text-sm xl:text-xl text-[#00171F] dark:text-[#F8F7FF] montserrat px-4 max-w-[36rem] flex-wrap">
            ...
            >
              ...
              <span className="font-medium">Mographllo</span>
            </Link>
            <Link
              href={"https://www.github.com/MographlloCode"}
              target="_bank"
              className="flex flex-col"
            >
              <span className="text-sm font-light">Github</span>
              <span className="font-medium">MographlloCode</span>
            </Link>
            <Link
              href={"https://www.behance.net/Mographllo"}
              target="_bank"
              className="flex flex-col"
            >
              <span className="text-sm font-light">Behance</span>
              <span className="font-medium">Mographllo</span>
            </Link>
            <Link
              href={"https://instagram.com/ogusmello"}
              target="_bank"
              className="flex flex-col"
            >
              <span className="text-sm font-light">Instagram</span>
              <span className="font-medium">@ogusmello</span>
            </Link>
            <Link
              href={"https://www.tiktok.com/@ogusmello"}
              target="_bank"
              className="flex flex-col"
            >
              <span className="text-sm font-light">TikTok</span>
              <span className="font-medium">@ogusmello</span>
            </Link>
            <Link
              href={"mailto:contact@gmello.tech"}
              target="_bank"
              className="flex flex-col"
            >
              <span className="text-sm font-light">Email</span>
              <span className="font-medium">contact@gmello.tech</span>
            </Link>
          </div>
        </section>
      </main>
      <footer className="flex flex-col">
        <p className="text-3xl text-[#00171F] dark:text-[#F8F7FF] harmond-semibold">
          Created By
        </p>
        <h1 className="kenoky-light uppercase text-5xl xl:text-9xl dark:text-[#F4E285] text-[#00171F]">
          Mographllo
        </h1>
      </footer>
    </section>
