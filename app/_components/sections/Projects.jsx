...
import ProjectGrid from '../parts/Projects/components/ProjectGrid'
  ...
  return (
    <section id='projects' className='flex flex-col gap-4 xl:gap-8 min-h-[540px] justify-between' >
      <header className='flex flex-col relative w-full items-end xl:p-8 gap-2'>
        ...
        <nav className='flex flex-wrap w-full xl:w-fit xl:flex-row gap-4 items-center'>
          <NavLink content={'back-end'} url={'#'} size={'big'} className='underline-offset-0 hover:underline-offset-4 hover:underline leading-3'/>
          <NavDivider />
          <NavLink content={'front-end'} url={'#'} size={'big'} className='underline-offset-0 hover:underline-offset-4 hover:underline leading-3'/>
          <NavDivider />
          <NavLink content={'full stack'} url={'#'} size={'big'} className='underline-offset-0 hover:underline-offset-4 hover:underline leading-3'/>
          <NavDivider />
          <NavLink content={'design'} url={'#'} size={'big'} className='underline-offset-0 hover:underline-offset-4 hover:underline leading-3'/>
        </nav>
      </header>
